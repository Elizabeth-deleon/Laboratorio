...
public class PanelVistaCliente extends javax.swing.JPanel {
    ...
    private void txtDatoClienteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDatoClienteKeyPressed
        String condicion = ClienController.clienteTmp.SELECT_POR_CODIGO;
        ...
        {
            condicion = ClienController.clienteTmp.SELECT_POR_NOMBRE+texto;
        }else if(rbRuc.isSelected())
        {
            condicion = ClienController.clienteTmp.SELECT_POR_RUC+texto;
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if(evt.getClickCount() == 2)
        {
            if(jTable1.getSelectedRow() != -1)
            {
                ...
                ClienController.setCliente(mtc.getFila(jTable1.getSelectedRow()));
