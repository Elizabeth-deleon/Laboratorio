...
public class PanelVistaVendedor extends javax.swing.JPanel {
    ...
    private void txtDatoVendedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDatoVendedorKeyPressed
        String condicion = VendController.vendedroTmp.SELECT_POR_CODIGO;
        ...
        {
            condicion = VendController.vendedroTmp.SELECT_POR_NOMBRE+texto;
        }else if(rbRuc.isSelected())
        {
            condicion = VendController.vendedroTmp.SELECT_POR_RUC+texto;
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if(evt.getClickCount() == 2)
        {
            if(jTable1.getSelectedRow() != -1)
            {
                ...
                VendController.setVendedor(mtc.getVendedor(jTable1.getSelectedRow()));
