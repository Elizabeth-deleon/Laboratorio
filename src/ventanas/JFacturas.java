...
public class JFacturas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cmbVendedor.setModel(new DefaultComboBoxModel(FactController.getCliente()));
    ...
    private void bntNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntNuevoActionPerformed
        ...
        cancelado = 0;
        txtPorcentajeDescuento.getText();  
    ...
    private void calcularValores()
    {
        ...
        this.txtDescuento.setText(df2.format(descuento));
        this.txtIva.setText(df2.format(iva));
        this.txtSubtotal.setText(df2.format(subTotal));
        this.txtTotal.setText(df2.format(total));
    ...
    private void cargarDatos()
    {
        if(factura != null)
        {
            ...
            this.txtTotal.setText(df2.format((factura.getSubTotal()-factura.getTotalDescuento()+factura.getTotalIva())));
            this.txtPagoInicial.setText(factura.getPagoInicial().toString());
            this.txtSaldo.setText(df2.format((factura.getPagoInicial()-(factura.getSubTotal()-factura.getTotalDescuento()+factura.getTotalIva()))));
