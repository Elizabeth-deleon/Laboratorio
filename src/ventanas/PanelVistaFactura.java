...
public class PanelVistaFactura extends javax.swing.JPanel {
    ...
    public void llenarTablaBusqueda()
    {
        ...
        {
            mtf = new ModeloTablaFactura(FactController.POR_CODIGO,txtNumFactura.getText()); 
            tblFacturas.setModel(mtf);
        ...
        {
            mtf = new ModeloTablaFactura(FactController.POR_FECHA,Helper.getFechaFormateada(dcFecha.getDate(),Helper.AÑO_MES_DIA)); 
            tblFacturas.setModel(mtf);
        }
    }
