...
public class FactController extends AbstractController{
	...
	Helper.getFechaFormateada(fc.getFecha(), Helper.AÑO_MES_DIA) +"','"+ 
	fc.getCliente().getId()+"','"+ 
    ...
    {        
        return new VendController().getRegistros();
    }
    ...
    private VFactura establecerFactura()
    {
        ...
        VendController cv = new VendController();
    ...
    {
        ArrayList<VFacturaDetalle> fd = getDetalleFactura(FactController.POR_CONDICION, VFacturaDetalle.SELECT_POR_FACTURA+"'"+id+"'"); 
        ArrayList<Articulo> lar = new ArrayList<Articulo>();
        //ArticuloController ar = new ArtiController();
...
//        }
    ...
    public ArrayList<VFacturaDetalle> getDetalleFactura(int tipoSeleccion, String cnd)
    {
        ...
        ArtiController ar = new ArtiController();
