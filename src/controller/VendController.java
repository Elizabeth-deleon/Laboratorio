...
import grupo3.conection.BaseConexion;
 ...
 * @author Grupo#3
 */
public class VendController extends AbstractController{
    ...
    public static void setVendedor(Vendedor vendedor) {
        VendController.vendedor = vendedor;
    }
	...
	vendedor.getCelular()+"','"+ 
	vendedor.getSexo()+"','"+ 
	Helper.getFechaFormateada(vendedor.getFechaIngreso(), Helper.AÑO_MES_DIA)+"','"+
        Helper.getFechaFormateada(vendedor.getFechaNacimiento(), Helper.AÑO_MES_DIA)+"','"+
        vendedor.getEmail()+"',"+
        vendedor.getVentas()+","+
        vendedor.getLabora()+","+        
	vendedor.getSueldo()+")";	
...
//        }
	...
	"CEL_VEN = '"+vendedor.getCelular()+"' ,"+ 
        ...
        "FEC_ING = '"+Helper.getFechaFormateada(vendedor.getFechaIngreso(), Helper.AÑO_MES_DIA)+"' ," +
	"FEC_NAC = '"+Helper.getFechaFormateada(vendedor.getFechaNacimiento(), Helper.AÑO_MES_DIA)+"' ,"+      
    ...
    {
        ArrayList<Vendedor> vnd = getRegistros(VendController.TODO, null);
