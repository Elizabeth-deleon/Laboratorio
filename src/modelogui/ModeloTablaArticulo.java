...
import controller.ArtiController;
...
public class ModeloTablaArticulo extends AbstractTableModel{
    ...
    ArtiController ac = new ArtiController();
    ...
    public ModeloTablaArticulo(int tipoVista) {
        ...
        articulos = ac.getRegistros(ArtiController.TODO,null);
    }
    ...
    public ModeloTablaArticulo(int tipoVista,String condicion) {
        ...
        articulos = ac.getRegistros(ArtiController.POR_CONDICION,condicion);
    }
