...
public class ModeloTablaCliente extends AbstractTableModel{
    ...
    private ClienController cc = new ClienController();
    ...
    public ModeloTablaCliente(int tipoVista) {
        ...
        clientes = cc.getRegistros(ClienController.TODO,null);
    }
    ...
    public ModeloTablaCliente(int tipoVista,String condicion) {
        ...
        if(tipoVista == VISTA)
            this.columnas = csmall;
        clientes = cc.getRegistros(ClienController.POR_CONDICION,condicion);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        }else
        {
            switch(columnIndex)
           {
               ...
               case 10:return Helper.getFechaFormateada(clientes.get(rowIndex).getFechaIngreso(), Helper.DIA_MES_AÑO);   
               default:return null;
           }
        }
    }
