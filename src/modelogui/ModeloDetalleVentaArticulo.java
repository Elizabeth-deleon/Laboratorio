...
public class ModeloDetalleVentaArticulo extends AbstractTableModel{
    ...
    public ModeloDetalleVentaArticulo(FactController cf,String id) {
        if(cf==null)
        {
            throw new NullPointerException("no se permite un controlador nulo");
        }
        detalles = cf.getDetalleFactura(FactController.POR_CONDICION, VFacturaDetalle.SELECT_POR_FACTURA+"'"+id+"'");
