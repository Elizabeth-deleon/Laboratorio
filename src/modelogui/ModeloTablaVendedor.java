...
public class ModeloTablaVendedor extends AbstractTableModel{
    ...
    public ModeloTablaVendedor(int tipoVista) {
        ...
        vendedores = cc.getRegistros(VendController.TODO,null);
    }
    ...
    public ModeloTablaVendedor(int tipoVista,String condicion) {
        ...
        if(tipoVista == VISTA)
            this.columnas = csmall;
        vendedores = cc.getRegistros(VendController.POR_CONDICION,condicion);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        }else
        {
            switch(columnIndex)
           {
               ...
               case 8:return Helper.getFechaFormateada(vendedores.get(rowIndex).getFechaIngreso(), Helper.DIA_MES_AÑO);   
               case 9:return Helper.getFechaFormateada(vendedores.get(rowIndex).getFechaNacimiento(), Helper.DIA_MES_AÑO);       
